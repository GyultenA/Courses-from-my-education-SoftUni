function solve() {
  const [generateButton, buyButton] = Array.from(document.querySelectorAll("button")); // niamt id
  //const [incomeText, resultTextArea] = document.querySelectorAll("textarea");
  //const tableBody = document.querySelector("tbody");

// console.log(generateButton,buyButton)
